([[
      ...
      internal logic will result in a global ban, and make you blacklisted from
        ...
        Luarmor v3.1a for Roblox, #1 lua whitelisting system by Federal#9999
				   https://luarmor.net/
